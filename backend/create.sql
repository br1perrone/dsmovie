...
alter table if exists tb_score add constraint FK321780fdsa7fdsafdsa54313v foreign key (movie_id) references tb_movie;
alter table if exists tb_score add constraint FK43242dfsaufd534uy1oi432dk foreign key (user_id) references tb_user;

INSERT INTO tb_user(email) VALUES ('michael@sf.ufp.org');
INSERT INTO tb_user(email) VALUES ('the.q@continuum.org');
INSERT INTO tb_user(email) VALUES ('picard@sf.ufp.org');
INSERT INTO tb_user(email) VALUES ('spock@sf.ufp.org');
INSERT INTO tb_user(email) VALUES ('kirk@sf.ufp.org');
INSERT INTO tb_user(email) VALUES ('macoy@sf.ufp.org');

INSERT INTO tb_movie(score, count, title, image) VALUES (4.5, 2, 'Star Trek: Discovery', 'https://www.themoviedb.org/t/p/w533_and_h300_bestv2/zh7GLsorxecv0D8d7QAVkQUe1ju.jpg');
INSERT INTO tb_movie(score, count, title, image) VALUES (3.3, 3, 'Duna', 'https://www.themoviedb.org/t/p/w533_and_h300_bestv2/jYEW5xZkZk2WTrdbMGAPFuBqbDc.jpg');
